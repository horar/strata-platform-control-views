...
Item {
    ...
    property real inputBoxWidth: Math.floor(implicitWidthHelper.width + infoText.padding * 2)
    ...
    Rectangle {
        ...
        TextInput {
            ...
            font {
                ...
                pixelSize: SGWidgets.SGSettings.fontPixelSize * root.fontSizeMultiplier
            }
            ...
            TextMetrics {
                ...
                property int lengthOfLongestString: Math.max(from.toString().length, to.toString().length) + decimalPlacesFromStepSize + (decimalPlacesFromStepSize > 0 ? 1 : 0) // if decimal places, add 1 for decimal point
            }
        }
    }
}
