...
Item {
    ...
    function demo_cirtain1(led_state){
    ...
    function demo_cirtain2(led_state){
    ...
    function demo_cirtain3(led_state){
    ...
    function demo_cirtain4(led_state){
    ...
    function demo_cirtain5(led_state){
