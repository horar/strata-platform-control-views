...
Rectangle {
    ...
    ListModel {
        ...
        property var baseModel: ({
            "commands": [
                {"cmd":"get_data","payload":null},
                {"cmd":"bat_en","payload":{"enable":"string"}},
                {"cmd":"vcc_en","payload":{"enable":"string"}},
                {"cmd":"reset_positionset_battv","payload":null},
                {"cmd":"reset_turns","payload":null},
                {"cmd":"reset_errors","payload":null},
                {"cmd":"set_low_batt","payload":{"battv_threshold":"double"}},
                {"cmd":"set_over_temp","payload":{"temp_threshold":"double"}},
                {"cmd":"get_alarmbattv","payload":null},
                {"cmd":"get_lowbattv","payload":null},
                {"cmd":"set_battv","payload":{"battv":"double"}},
            ],
            "notifications": [
                {"payload":{"accel":"int","pos":"int","time":"double","turns":"int","vel":"int"},"value":"get_NCS32200_data"},
                {"payload":{"batt_alarm":"int","low_bat":"int","no_power":"int","over_temp":"int","overflow":"int","overspeed":"int","sensor_error":"int"},"value":"get_NCS32200_errors"},
                {"payload":{"temperature":"int"},"value":"get_NCS32200_temperature"},
                {"payload":{"ibat":"double","vbat":"double","vcc":"double"},"value":"status_telemetry"},
                {"payload":{"position":"int"},"value":"reset_position"},
                {"payload":{"turns":"int"},"value":"reset_turns"},
                {"payload":{"batt_alarm":"int","low_bat":"int","no_power":"int","over_temp":"int","overflow":"int","overspeed":"int","sensor_error":"int"},"value":"reset_errors"},
                {"payload":{"battv_threshold":"double"},"value":"set_low_batt"},
                {"payload":{"temp_threshold":"int"},"value":"set_over_temp"},
                {"payload":{"alarm_threshold":"int"},"value":"get_alarmbattv"},
                {"payload":{"lowbatt_threshold":"double"},"value":"get_lowbattv"},
                {"payload":{"battv":"double"},"value":"set_battv"},
            ]
        })
