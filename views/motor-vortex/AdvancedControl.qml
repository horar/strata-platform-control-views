...
Rectangle {
    ...
    Component.onCompleted:  {
        ...
        Help.registerTarget( navTabs, "These tabs switch between Basic and Advanced control views. The FAE Only tab is restricted for onsemi field engineers.", 0 , "advanceViewHelp")
