...
Rectangle {
    ...
    ListModel {
        ...
        property var baseModel: ({
            "commands": [
                {"cmd":"read","payload":{"characteristic":"string","service":"string"}},
                {"cmd":"write","payload":{"characteristic":"string","data":"string","service":"string"}},
                {"cmd":"write_descriptor","payload":{"characteristic":"string","data":"string","descriptor":"string","service":"string"}},
            ],
            "notifications": [
                {"payload":{"characteristic":"string","data":"string","service":"string"},"value":"read"},
                {"payload":{"characteristic":"string","data":"string","service":"string"},"value":"notify"},
            ]
        })
