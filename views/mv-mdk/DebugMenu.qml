    ...
    ListModel {
        ...
        property var baseModel: ({
            ...
            "notifications": [
                ...
                {"payload":{"caption":"string"},"value":"actual_speed_caption"},
                {"payload":{"scales":["int","int","int"]},"value":"actual_speed_scales"},
                {"payload":{"states":"array-dynamic"},"value":"actual_speed_states"},
                {"payload":{"value":"double"},"value":"actual_speed_value"},
                {"payload":{"values":"array-dynamic"},"value":"actual_speed_values"},
                {"payload":{"caption":"string","scales":["int","int","int"],"states":"array-dynamic","value":"double","values":"array-dynamic"},"value":"target_speed"},
                {"payload":{"caption":"string"},"value":"target_speed_caption"},
                {"payload":{"scales":["int","int","int"]},"value":"target_speed_scales"},
                {"payload":{"states":"array-dynamic"},"value":"target_speed_states"},
                {"payload":{"value":"double"},"value":"target_speed_value"},
                {"payload":{"values":"array-dynamic"},"value":"target_speed_values"},
                {"payload":{"caption":"string","scales":["int","int","int"],"states":"array-dynamic","value":"double","values":"array-dynamic"},"value":"acceleration"},
                {"payload":{"caption":"string"},"value":"acceleration_caption"},
                {"payload":{"scales":["int","int","int"]},"value":"acceleration_scales"},
                {"payload":{"states":"array-dynamic"},"value":"acceleration_states"},
                {"payload":{"value":"double"},"value":"acceleration_value"},
                {"payload":{"values":"array-dynamic"},"value":"acceleration_values"},
                {"payload":{"caption":"string","scales":["int","int","int"],"states":"array-dynamic","value":"double","values":"array-dynamic"},"value":"board_temp"},
                {"payload":{"caption":"string"},"value":"board_temp_caption"},
                {"payload":{"scales":["int","int","int"]},"value":"board_temp_scales"},
                {"payload":{"states":"array-dynamic"},"value":"board_temp_states"},
                {"payload":{"value":"double"},"value":"board_temp_value"},
                {"payload":{"values":"array-dynamic"},"value":"board_temp_values"},
                {"payload":{"caption":"string","scales":["int","int","int"],"states":"array-dynamic","value":"double","values":"array-dynamic"},"value":"input_voltage"},
                {"payload":{"caption":"string"},"value":"input_voltage_caption"},
                {"payload":{"scales":["int","int","int"]},"value":"input_voltage_scales"},
                {"payload":{"states":"array-dynamic"},"value":"input_voltage_states"},
                {"payload":{"value":"double"},"value":"input_voltage_value"},
                {"payload":{"values":"array-dynamic"},"value":"input_voltage_values"},
                {"payload":{"caption":"string"},"value":"title_caption"},
                {"payload":{"caption":"string"},"value":"subtitle_caption"},
                {"payload":{"caption":"string","scales":["int","int","int"],"states":"array-dynamic","value":"bool","values":"array-dynamic"},"value":"warning_1"},
                {"payload":{"caption":"string"},"value":"warning_1_caption"},
                {"payload":{"scales":["int","int","int"]},"value":"warning_1_scales"},
                {"payload":{"states":"array-dynamic"},"value":"warning_1_states"},
                {"payload":{"value":"bool"},"value":"warning_1_value"},
                {"payload":{"values":"array-dynamic"},"value":"warning_1_values"},
                {"payload":{"caption":"string","scales":["int","int","int"],"states":"array-dynamic","value":"bool","values":"array-dynamic"},"value":"warning_2"},
                {"payload":{"caption":"string"},"value":"warning_2_caption"},
                {"payload":{"scales":["int","int","int"]},"value":"warning_2_scales"},
                {"payload":{"states":"array-dynamic"},"value":"warning_2_states"},
                {"payload":{"value":"bool"},"value":"warning_2_value"},
                {"payload":{"values":"array-dynamic"},"value":"warning_2_values"},
                {"payload":{"caption":"string","scales":["int","int","int"],"states":"array-dynamic","value":"bool","values":"array-dynamic"},"value":"warning_3"},
                {"payload":{"caption":"string"},"value":"warning_3_caption"},
                {"payload":{"scales":["int","int","int"]},"value":"warning_3_scales"},
                {"payload":{"states":"array-dynamic"},"value":"warning_3_states"},
                {"payload":{"value":"bool"},"value":"warning_3_value"},
                {"payload":{"values":"array-dynamic"},"value":"warning_3_values"},
                {"payload":{"value":"string"},"value":"status_log_value"},
            ]
        })
