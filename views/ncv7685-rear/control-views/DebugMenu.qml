    ...
    ListModel {
        ...
        property var baseModel: ({
            "commands": [
                ...
                {"cmd":"get_firmware_info","payload":null},
                {"cmd":"demo_welcome","payload":{"one_shot":"bool"}},
                {"cmd":"demo_byebye","payload":{"one_shot":"bool"}},
                {"cmd":"demo_left_turn","payload":{"cycle":"int","one_shot":"bool","period":"int"}},
                {"cmd":"demo_right_turn","payload":{"cycle":"int","one_shot":"bool","period":"int"}},
                {"cmd":"demo_brake","payload":{"strength":"int"}},
                {"cmd":"demo_fading","payload":{"cycle":"int","one_shot":"bool","period":"int"}},
                {"cmd":"demo_warning","payload":{"cycle":"int","one_shot":"bool","period":"int"}},
                {"cmd":"led_all","payload":{"setting":"string"}},
                {"cmd":"pwm_setting","payload":{"autor":"bool","pwm_freq":"int","pwm_linear":"bool"}},
                {"cmd":"adc_setting","payload":{"period":"int","working":"bool"}},
                {"cmd":"dcs_1","payload":{"sth":["int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int"]}},
                {"cmd":"dcs_2","payload":{"sth":["int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int"]}},
            ],
            "notifications": [
                {"payload":{"board_count":"int","class_id":"string","name":"string","platform_id":"string","platform_id_version":"string"},"value":"platform_id"},
                {"payload":{"date":"string","type":"string","version":"string"},"value":"get_firmware_info"},
                {"payload":{"one_shot":"bool"},"value":"demo_welcome"},
                {"payload":{"one_shot":"bool"},"value":"demo_byebye"},
                {"payload":{"cycle":"int","one_shot":"bool","period":"int"},"value":"demo_left_turn"},
                {"payload":{"cycle":"int","one_shot":"bool","period":"int"},"value":"demo_right_turn"},
                {"payload":{"strength":"int"},"value":"demo_brake"},
                {"payload":{"cycle":"int","one_shot":"bool","period":"int"},"value":"demo_fading"},
                {"payload":{"cycle":"int","one_shot":"bool","period":"int"},"value":"demo_warning"},
                {"payload":{"status":"string"},"value":"led_all"},
                {"payload":{"autor":"bool","pwm_freq":"int","pwm_linear":"int"},"value":"pwm_setting"},
                {"payload":{"period":"int","working":"bool"},"value":"adc_setting"},
                {"payload":{"i_in":"int","v_in":"int"},"value":"input_voltage_current"},
                {"payload":{"led_0_35":"int","sth":["int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int"]},"value":"dcs_1"},
                {"payload":{"led_36_71":"int","sth":["int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int","int"]},"value":"dcs_2"},
            ]
        })
