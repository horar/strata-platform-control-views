...
Item {
    ...
    property var set_vin_mains: ({
                                         "cmd" : "set_vin_mains",
                                         "payload": {
                                             "vin_mains": 0 ,
                                         },

                                         update: function (vin_mains) {
                                             this.set(vin_mains)
                                             CorePlatformInterface.send(this)
                                         },
                                         set: function (vin_mains) {
                                             this.payload.vin_mains = vin_mains;
                                         },
                                         send: function () { CorePlatformInterface.send(this) },
                                         show: function () { CorePlatformInterface.show(this) }
                                     })
